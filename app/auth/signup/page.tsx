...
import { AlertCircle, Eye, EyeOff, CheckCircle, Menu, X, ArrowLeft } from 'lucide-react';
...
export default function SignUpPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Google redirect will handle the navigation
    } catch (err) {
      setError('An unexpected error occurred');
    } finally {
      setLoading(false);
  ...
  const handleLinkedInSignIn = async () => {
    ...
    try {
      ...
      // LinkedIn redirect will handle the navigation
    } catch (err) {
      setError('An unexpected error occurred');
    } finally {
      setLoading(false);
          ...
          <div className="relative h-full flex items-center justify-center">
            <div className="text-center space-y-4 text-white">
              ...
              <h1 className="text-3xl lg:text-4xl font-bold">
                Check Your <span className="text-blue-200">Email</span>
              </h1>
        ...
        <section className="relative overflow-hidden" style={{ height: "200px" }}>
          ...
          <div className="relative h-full flex items-center justify-center">
            <div className="text-center space-y-4 text-white">
              ...
              <h1 className="text-3xl lg:text-4xl font-bold">
                Welcome to <span className="text-blue-200">InterviewIQ</span>
              </h1>
              <p className="text-lg text-blue-100 max-w-2xl mx-auto">
          ...
          <div className="flex justify-center">
            <Card className="w-full max-w-md">
              <CardContent className="p-8 text-center space-y-4">
                ...
                <CardTitle className="text-2xl font-bold text-green-900">Welcome to InterviewIQ!</CardTitle>
                <CardDescription className="text-base">
