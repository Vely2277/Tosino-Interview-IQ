        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center space-y-4">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold">
              Practice <span className="text-blue-200">Interview</span>
            </h1>
          ...
          <div className="space-y-8">
            ...
            <Card className="shadow-2xl border-0 bg-white overflow-hidden">
              <CardHeader className="bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 text-white">
                <CardTitle className="text-3xl text-center font-bold flex items-center justify-center space-x-3">
                ...
                <div className="space-y-8">
                  <div className="space-y-3">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        required
                        className="h-14 text-lg border-3 border-gray-300 focus:border-blue-600 rounded-xl shadow-sm bg-white pl-6 pr-4"
                      />
                  ...
                  <div className="pt-8">
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 hover:from-blue-700 hover:via-purple-700 hover:to-blue-900 text-white py-8 text-2xl font-black rounded-2xl shadow-2xl hover:shadow-3xl transition-all transform hover:scale-105 hover:rotate-1 border-2 border-white/20"
                      size="lg"
                    >
            ...
            <Card className="text-center p-8 bg-white shadow-lg border-0">
              <CardContent className="space-y-6">
                ...
                <div className="text-gray-700 text-lg min-h-[100px] flex items-center justify-center leading-relaxed px-4">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="text-center p-6 bg-white shadow-lg border-0 hover:shadow-xl transition-shadow">
              ...
              <Card className="text-center p-6 bg-white shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="space-y-4">
                  ...
                  <h3 className="text-lg font-semibold">Targeted Practice</h3>
                  <p className="text-gray-600 text-sm">
              ...
              <Card className="text-center p-6 bg-white shadow-lg border-0 hover:shadow-xl transition-shadow">
                <CardContent className="space-y-4">
                  ...
                  <h3 className="text-lg font-semibold">Real Feedback</h3>
                  <p className="text-gray-600 text-sm">
